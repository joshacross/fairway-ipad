...
const Edit = () => {
  ...
  return (
    <div className="bg-secondary h-screen">
      ...
      <div className="mx-auto items-center w-8/12 h-8/12 mt-3">
        <main className="flex flex-col justify-between m-auto text-center bg-home-page bg-no-repeat bg-top bg-cover w-[1180px] h-[820px]">
          {isMobile ? (
                ...
                <div className={pageStyles.contactCard}>
                  ...
                  <div>
                    <h4
                      ...
                      suppressContentEditableWarning
                      onBlur={(e) =>
                        handleChange({ loName: e.target.innerHTML })
                      }
                ...
                <div className={pageStyles.contactCard}>
                  ...
                  <div>
                    <h4
                      ...
                      suppressContentEditableWarning
                      onBlur={(e) =>
                        handleChange({ r1Name: e.target.innerHTML })
                      }
                      className="text-base font-bold hover:border"
                    >
                      {values.r1Name}
                ...
                <div className={pageStyles.contactCard}>
                  ...
                  <div>
                    <h4
                      ...
                      suppressContentEditableWarning
                      onBlur={(e) =>
                        handleChange({ r2Name: e.target.innerHTML })
                      }
                      className="text-base font-bold hover:border"
                    >
                      {values.r2Name}
